 ...
 * @author Mayuwhim (drawImage transparency)
 * @version 4.5
 */
...
*/
	...
	//Look above for rest of the functionalities
	/**
	 * @param		alpha the transparency of the image, 0.0 is fully transparent while 1.0 is fully opaque.
	 */
	public void drawImage(Image img, int x, int y, float alpha) {
		canvas.drawImage(img, x, y, alpha);
	}
	
	public void drawImage(Image img, int x, int y, int width, int height, float alpha) {
		canvas.drawImage(img, x, y, width, height, alpha);
	}
	
	public void drawImage(Image img,
			int dx1,int dy1,int dx2,int dy2,
			int sx1,int sy1,int sx2,int sy2,float alpha, ImageObserver observer) {
				canvas.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, alpha, observer);		
	}
